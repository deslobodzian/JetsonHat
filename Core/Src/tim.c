...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PC1     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOC, ENC_1_A_Pin|ENC_1_B_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOA, ENC_2_B_Pin|ENC_2_A_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, ENC_3_A_Pin|ENC_3_B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, ENC_4_A_Pin|ENC_4_B_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA0     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(ENC_A_ABS_GPIO_Port, ENC_A_ABS_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC6     ------> TIM8_CH1
    */
    HAL_GPIO_DeInit(ENC_3_ABS_GPIO_Port, ENC_3_ABS_Pin);
  ...
  /* USER CODE END TIM15_MspDeInit 0 */
    ...
    PA2     ------> TIM15_CH1
    */
    HAL_GPIO_DeInit(ENC_2_ABS_GPIO_Port, ENC_2_ABS_Pin);
  ...
  /* USER CODE END TIM20_MspDeInit 0 */
    ...
    PB2     ------> TIM20_CH1
    */
    HAL_GPIO_DeInit(ENC_4_ABS_GPIO_Port, ENC_4_ABS_Pin);
